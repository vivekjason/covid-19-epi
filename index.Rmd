...
clusters <- read_csv("P:/COVID-19/R0 Malaysia/data/cluster data/clusters3.csv", 
    col_types = cols(no = col_number(), bangau = col_number(), 
        ...
        tembok_nenas=col_number(), teratai=col_number()))
...
df$ins <- df$dti+df$tembok+df$benteng_pk+df$penjara_reman+df$penjara_jawi+df$kepayan+df$penjara_tapah+
  ...
  df$tembok_mempaga + df$telok_mas +df$tropika + df$tembok_kemus + df$tembok_nenas
...
#load data
Global_Mobility_Report_3_ <- read_csv("P:/COVID-19/R0 Malaysia/data/mobility/Global_Mobility_Report_210118.csv", 
