...
clusters <- read_csv("P:/COVID-19/R0 Malaysia/data/cluster data/clusters_dashboard.csv", 
    col_types = cols(no = col_number(), bangau = col_number(), 
        ...
        dti_lenggeng=col_number(), dti_sandakan=col_number()))
...
#load data
Global_Mobility_Report_3_ <- read_csv("P:/COVID-19/R0 Malaysia/data/mobility/Global_Mobility_Report_210417.csv", 
