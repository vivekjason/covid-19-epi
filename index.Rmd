...
clusters <- read_csv("P:/COVID-19/R0 Malaysia/data/cluster data/clusters_dashboard_v3.csv", 
...
#pull new data set
df <- read_csv("P:/COVID-19/R0 Malaysia/data/incidence/covid-19_my_v7.csv", 
...
mas_pop <- 32730000
mas_bed <- 27183+10190 #last updated on 29 May 2021 
mas_icu <- 1698# total for covid is 1113  but we use the max
mas_ven <- 2138#all ventilators
...
ts_mas$mortality14 <- rollsum(ts_mas$death,k=7,fill=NA, align="right")
...
ts_mas$mortality_cum<- round((ts_mas$cumsum_death/mas_pop)*100000,2)
ts_mas$mortality14_rate <- round((ts_mas$mortality14/mas_pop)*100000,2)
...
write.csv(Global_Mobility_Report_3_, paste0("P:/COVID-19/R0 Malaysia/data/mobility/Global_Mobility_Report_3_",as.character(format(Sys.Date(), "%y%m%d")), ",csv"))

#pull vaccination data and replace in vaccination folder
...
#write csv to driectoryies
write.csv(vax_state, "P:/COVID-19/R0 Malaysia/data/vaccination/vax_state.csv")
write.csv(vax_malaysia, "P:/COVID-19/R0 Malaysia/data/vaccination/vax_malaysia.csv")
write.csv(vaxreg_malaysia, "P:/COVID-19/R0 Malaysia/data/vaccination/vaxreg_malaysia.csv")
write.csv(vaxreg_state, "P:/COVID-19/R0 Malaysia/data/vaccination/vaxreg_state.csv")

#write.csv(ts_mas, "P:/IPPC/Epid Report/mas.csv")
```
...
df <- read_csv("P:/COVID-19/R0 Malaysia/data/incidence/covid-19_my_state_v5.csv", 
        col_types = cols(date = col_date(format = "%d/%m/%Y"), 
...
perlis_r0_df$date <- seq(from=as.Date("2020-03-20"),to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
perlis_r0_df$mortality14 <- rollsum(perlis_r0_df$new_death,k=7,fill=NA, align="right")
...
kedah_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
kedah_r0_df$mortality14 <- rollsum(kedah_r0_df$new_death,k=7,fill=NA, align="right")
#average mobility of 5 scores for each state`
...
penang_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
penang_r0_df$mortality14 <- rollsum(penang_r0_df$new_death,k=7,fill=NA, align="right")
...
perak_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
perak_r0_df$mortality14 <- rollsum(perak_r0_df$new_death,k=7,fill=NA, align="right")
...
selangor_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)  
...
selangor_r0_df$mortality14 <- rollsum(selangor_r0_df$new_death,k=7,fill=NA, align="right")
...
kl_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
kl_r0_df$mortality14 <- rollsum(kl_r0_df$new_death,k=7,fill=NA, align="right")
...
putrajaya_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
putrajaya_r0_df$mortality14 <- rollsum(putrajaya_r0_df$new_death,k=7,fill=NA, align="right")
...
negeri_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
negeri_r0_df$mortality14 <- rollsum(negeri_r0_df$new_death,k=7,fill=NA, align="right")
...
melaka_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
melaka_r0_df$mortality14 <- rollsum(melaka_r0_df$new_death,k=7,fill=NA, align="right")
...
johor_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day) 
...
johor_r0_df$mortality14 <- rollsum(johor_r0_df$new_death,k=7,fill=NA, align="right")
...
pahang_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
pahang_r0_df$mortality14 <- rollsum(pahang_r0_df$new_death,k=7,fill=NA, align="right")
...
terengganu_r0_df$date <- seq(from=as.Date("2020-03-20"),to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
terengganu_r0_df$mortality14 <- rollsum(terengganu_r0_df$new_death,k=7,fill=NA, align="right")
...
kelantan_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
kelantan_r0_df$mortality14 <- rollsum(kelantan_r0_df$new_death,k=7,fill=NA, align="right")
...
sabah_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
sabah_r0_df$mortality14 <- rollsum(sabah_r0_df$new_death,k=7,fill=NA, align="right")
...
sarawak_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day)
...
sarawak_r0_df$mortality14 <- rollsum(sarawak_r0_df$new_death,k=7,fill=NA, align="right")
...
labuan_r0_df$date <- seq(from=as.Date("2020-03-20"), to=as.Date(Sys.Date()-1),by=1) # TODO: if elapsed by a day -1 from the date (-1 for each elapsed day) 
...
labuan_r0_df$mortality14 <- rollsum(labuan_r0_df$new_death,k=7,fill=NA, align="right")
...
state_data_v2 <- read_excel("P:/COVID-19/R0 Malaysia/data/population_healthcapacity/state_data_v3.xlsx", 
    col_types = c("text","text", "date", "numeric", 
        ...
        "numeric","numeric","numeric",
        "numeric", "numeric"))
state_data_v2 <- state_data_v2 %>% filter (status=="use")
...
#add 14-day mortality by states
perlis$mortality14_rate <- round((perlis$mortality14/state_data_v2$population_new[state_data_v2$state=="Perlis"])*100000,2)
kedah$mortality14_rate <- round((kedah$mortality14 /state_data_v2$population_new[state_data_v2$state=="Kedah"])*100000,2)
penang$mortality14_rate <- round((penang$mortality14 /state_data_v2$population_new[state_data_v2$state=="Pulau Pinang"])*100000,2)
perak$mortality14_rate <- round((perak$mortality14 /state_data_v2$population_new[state_data_v2$state=="Perak"])*100000,2)
selangor$mortality14_rate <- round((selangor$mortality14 /state_data_v2$population_new[state_data_v2$state=="Selangor"])*100000,2)
kl$mortality14_rate <- round((kl$mortality14 /state_data_v2$population_new[state_data_v2$state=="W.P. Kuala Lumpur"])*100000,2)
putrajaya$mortality14_rate <- round((putrajaya$mortality14 /state_data_v2$population_new[state_data_v2$state=="W.P. Putrajaya"])*100000,2)
melaka$mortality14_rate <- round((melaka$mortality14 /state_data_v2$population_new[state_data_v2$state=="Melaka"])*100000,2)
negeri$mortality14_rate <- round((negeri$mortality14 /state_data_v2$population_new[state_data_v2$state=="Negeri Sembilan"])*100000,2)
johor$mortality14_rate <- round((johor$mortality14 /state_data_v2$population_new[state_data_v2$state=="Johor"])*100000,2)
pahang$mortality14_rate <- round((pahang$mortality14 /state_data_v2$population_new[state_data_v2$state=="Pahang"])*100000,2)
terengganu$mortality14_rate <- round((terengganu$mortality14 /state_data_v2$population_new[state_data_v2$state=="Terengganu"])*100000,2)
kelantan$mortality14_rate <- round((kelantan$mortality14 /state_data_v2$population_new[state_data_v2$state=="Kelantan"])*100000,2)
sabah$mortality14_rate <- round((sabah$mortality14 /state_data_v2$population_new[state_data_v2$state=="Sabah"])*100000,2)
sarawak$mortality14_rate <- round((sarawak$mortality14 /state_data_v2$population_new[state_data_v2$state=="Sarawak"])*100000,2)
labuan$mortality14_rate <- round((labuan$mortality14 /state_data_v2$population_new[state_data_v2$state=="W.P. Labuan"])*100000,2)


#add in a column for hospitals and icu beds
perlis$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Perlis"]
kedah$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Kedah"]
penang$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Pulau Pinang"]
perak$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Perak"]
selangor$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Selangor"]
kl$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="W.P. Kuala Lumpur"]
putrajaya$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="W.P. Putrajaya"]
melaka$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Melaka"]
negeri$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Negeri Sembilan"]
johor$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Johor"]
pahang$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Pahang"]
kelantan$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Kelantan"]
terengganu$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Terengganu"]
sabah$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Sabah"]
sarawak$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="Sarawak"]
labuan$hbed <- state_data_v2$estimated_covid19_beds[state_data_v2$state=="W.P. Labuan"]
...
mas_state <- left_join(ts_mas, state_full, by=c("state","date","incidence","incidence14_rate","mortality14_rate","bed_perc5"))

mas_state <- mas_state%>% filter(date>as.Date("2020-03-19"))
#write.csv(state_full, "P:/IPPC/Epid Report/state.csv")
```
...
region <- state %>% dplyr::select(date,region,new_cases,total_cases) %>% group_by(date,region) %>% summarise(new=sum(new_cases), total=sum(total_cases))
...
```{r}
total_cases <- core_set$total_cases[nrow(core_set)]
...
```{r}
total_deaths <- core_set$total_deaths[nrow(core_set)]
...
```{r}
total_deaths <- core_set$total_recover[nrow(core_set)]
valueBox(value=total_deaths,
...
Cols {.tabset}
-------------------------------------
### 7-day incidence density
```{r}
mas_inc_curve <- plot_ly() %>%
  add_lines(data=incidence_df %>% filter(group=="state"), x=~date,y = ~incidence14/2, name=~state, color=~state,
  ...
  add_lines(data=incidence_df %>% filter(group=="region"), x=~date,y = ~incidence14_2/2, name=~location, color=~location, 
            colors=c("#CD2626", "#008B45", "#63B8FF", "#2B2B2B", "#FFAEB9", "#EEC900"), visible=FALSE)%>% 
  layout(title = paste0("7-day incidence density of COVID-19 cases",
                 '<br>',
                 '<i>',
  ...
  layout(yaxis = list(type = "log",  
                      tickvals = as.list(c(0.1,1,10,50,100,150,1000)))) %>% 
  layout(titlefont=list(size=12)) %>%
  config(modeBarButtonsToRemove = c("zoomIn2d", "zoomOut2d", "autoScale2d", "resetScale2d", "hoverClosestCartesian", "hoverCompareCartesian","lasso2d", "select2d", "pan2d","zoom2d")) %>%
  layout(xaxis=list(fixedrange=TRUE)) %>% layout(yaxis=list(fixedrange=TRUE)) %>%
  config(displaylogo = FALSE)  %>%
...
```{r}
state_full <- state_full %>% group_by(state) %>%
  fill(mortality14_rate) %>%
  mutate(mortality14_rate = rollmean(mortality14_rate, k = 7, fill = "extend"))

mas_death_curve <- plot_ly() %>%
  add_lines(data=state_full, x=~date,y = ~mortality14_rate, name=~state, color=~state,
            colors=c("#0000FF", "#63B8FF", "#006400", "#008B45", "#54FF9F", "#C71585", "#EEC900", "#FF8C00", "#68228B", "#FFAEB9", "#CD2626", "#008B8B", "#ADD8E6",
                      "#F08080", "#696969", "#2B2B2B", "#FF1493")) %>%
  layout(title = paste0("7-day COVID-19 Mortality rate",
                 '<br>',
                 '<i>',
                 'Malaysia: National and State Level',
                 '</i>'),
  xaxis = list(title = "Date", domain = c(0, 1)),
  yaxis = list(title = paste0("7-day Mortality rate",
                              '<br>',
                              "(per 100,000 population)"))) %>% 
  layout(
    images = list(
...
mas_cap_curve <- ggplot(data=ts_mas,aes(x=date)) +
  geom_line(aes(y=`General bed utilisation (%) (n= 37373 )`,col="General bed utilisation (%) (n= 37373 )"),
            stat="identity",size=0.6, show.legend = T) + 
  geom_line(aes(y=`ICU bed utilisation (%) (n= 1698 )`,col="ICU bed utilisation (%) (n= 1698 )"),
            stat="identity",size=0.6,show.legend = T) +
  geom_line(aes(y=`Ventilator utilisation (%) (n= 2138 )`, col="Ventilator utilisation (%) (n= 2138 )"),
            stat="identity",size=0.6,alpha=0.6, show.legend = T) +
  scale_colour_manual(name = "",labels = c("General bed utilisation (%) (n= 37373 )"="General bed utilisation (%)\n 
                                           (n= 25456 )", 
                                           "ICU bed utilisation (%) (n= 1698 )"="ICU bed utilisation (%)\n
                                           (n= 871 )", 
                                           "Ventilator utilisation (%) (n= 2138 )"="Ventilator utilisation (%)\n
                                           (n= 1581 )"),
                      values = c("General bed utilisation (%) (n= 37373 )"="#003f5c", 
                                 "ICU bed utilisation (%) (n= 1698 )"="#C14953", 
                                 "Ventilator utilisation (%) (n= 2138 )"="#ffa600")) +
  ...
  theme(legend.position = c(.95, .5),
        ...
        axis.title.y=element_text(size=10),
        axis.title = element_text(size=10)) +
  ylim(0,max(ts_mas$`General bed utilisation (%) (n= 37373 )`)*1.25) +
  scale_x_date(date_breaks = "4 week", date_minor_breaks = "1 day",
               date_labels = "%e %b", limits =c(as.Date(Sys.Date()-91),as.Date(Sys.Date()+1))) +
...
perlis_bed_curve <- plot_ly(perlis, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(perlis$bed_perc9)*1.25))) %>%
...
kedah_bed_curve <- plot_ly(kedah, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(kedah$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
penang_bed_curve <- plot_ly(penang, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(penang$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
perak_bed_curve <- plot_ly(perak, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(perak$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
selangor_bed_curve <- plot_ly(selangor, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(selangor$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
kl_bed_curve <- plot_ly(kl, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(kl$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
putrajaya_bed_curve <- plot_ly(putrajaya,x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(putrajaya$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
negeri_bed_curve <- plot_ly(negeri, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(negeri$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
melaka_bed_curve <- plot_ly(melaka, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(melaka$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
johor_bed_curve <- plot_ly(johor, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(johor$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
pahang_bed_curve <- plot_ly(pahang, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(pahang$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
terengganu_bed_curve <- plot_ly(pahang,x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(terengganu$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
kelantan_bed_curve <- plot_ly(kelantan, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(kelantan$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
sarawak_bed_curve <- plot_ly(sarawak, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(sarawak$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
sabah_bed_curve <- plot_ly(sabah, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(sabah$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
labuan_bed_curve <- plot_ly(labuan, x = ~date, y = ~bed_perc9, type = 'scatter', mode = 'lines',
  ...
  layout(paper_bgcolor="white", plot_bgcolor="white",
         ...
         yaxis = list(title = "Estimated bed occupancy rate (%)",
                      ...
                      ticks = 'outside',
                      zeroline = FALSE,
                      range = c(0,max(labuan$bed_perc9)*1.25))) %>%
  layout(title = list(text = paste0("Estimated bed-occupancy rate",
                                    '<br>',
                                    '<i>',
...
-------------------------------------
### National Test Positivity Ratio
```{r}
#load data
test <- read_excel("P:/COVID-19/R0 Malaysia/data/testing/testing_v3.xlsx", 
    col_types = c("date", "numeric", "numeric"))

#add the new_cases, positivity rate and testing rate
test_mas <-  core_set %>% dplyr::select(date, new_cases) %>% 
  left_join(test, by="date") %>%
  mutate(test_ma7 = rollmean(new_tests, k = 7, fill = "extend"),
         cases_ma7= rollmean(new_cases, k = 7, fill = "extend"),
         positivity_rate= (new_cases/new_tests)*100,
         positivity_rate_ma=(cases_ma7/test_ma7)*100,
         testing_rate=(test_ma7/mas_pop)*1000)
...
a <- list(
  x = as.numeric(as.POSIXct(Sys.Date()-75, format="%Y-%m-%d"))*1000,
  y = (((max(test_mas$cases)*1.15)*5)/15)+250,
  font = list(size = 8),
  text = "WHO recommended test positivity ratio threshold of 5%",
  showarrow = F
)

#filter outdates
test_mas <- test_mas %>% filter(date>Sys.Date()-91)

#plot for malaysia
mas_test_curve <- plot_ly() %>%
  add_bars(data = test_mas, x = ~date, y = ~new_cases, name = "New cases", marker=list(color="grey")) %>%
    add_lines(data = test_mas, x = ~date, y = ~positivity_rate_ma, name = "Positivity ratio (7-day Moving Average)", line=list(width = 4, color = 'rgb(254,1,154)'),
            yaxis = 'y2') %>%
  add_lines(data = test_mas, x = ~date, y = ~positivity_rate, name = "Positivity ratio", line=list(width = 4, color ='rgb(207,255,4)'),
            yaxis = 'y2') %>%
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
                      range = 
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(test_mas$cases)*1.15),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(0,20),
                       title = paste0("Test Positivity",
                                    '<br>', "rate (%)"),
         legend = list(x = 1.05, y = 0.9))) %>%
  add_segments(x = as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
               xend = as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000, 
               y = ((max(test_mas$cases)*1.15)*5)/15, yend = ((max(test_mas$cases)*1.15)*5)/15,
               type = "line",
  line = list(color = "grey",
              dash="dot"), showlegend = FALSE) 
  
mas_test_curve %>% layout(
    images = list(
      list(source = base64enc::dataURI(file = "Picture1.png"),
           xref = "paper",
           yref = "paper",
  ...
  layout(xaxis = list(autorange = TRUE)) %>%
  layout(title = list(text = paste0("Test Positivity ratio",
                                    '<br>',
                                    '<i>',
                                    "Malaysia",
                                    '</i>'))) %>%
...
test_mas <-  core_set %>% dplyr::select(date, new_cases) %>% 
  ...
  mutate(test_ma7 = rollmean(new_tests, k = 7, fill = "extend"),
         ...
         positivity_rate= (new_cases/new_tests)*100,
         positivity_rate_ma=(cases_ma7/test_ma7)*100,
         testing_rate=(new_tests/mas_pop)*1000,
         testing_rate_ma=(test_ma7/mas_pop)*1000,)
...
mas_test_curve <- plot_ly() %>%
  add_bars(data = test_mas, x = ~date, y = ~new_cases, name = "New cases", marker=list(color="grey")) %>%
    add_lines(data = test_mas, x = ~date, y = ~testing_rate_ma, name = "Testing rate (7-day moving average)", line=list(width = 4, color = 'rgb(254,1,154)'),
            yaxis = 'y2') %>%
  add_lines(data = test_mas, x = ~date, y = ~testing_rate, name = "Testing rate", line=list(width = 4, color ='rgb(207,255,4)'),
            yaxis = 'y2') %>%
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
                      range = 
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(test_mas$new_cases)*1.15),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(0,7.5),
                       title = paste0("Testing rate",
                                    '<br>', "(per 1000 population)"),
         legend = list(x = 1.05, y = 0.9)))
mas_test_curve %>% layout(
    images = list(
      list(source = base64enc::dataURI(file = "Picture1.png"),
  ...
  layout(xaxis = list(autorange = TRUE)) %>%
  layout(title = list(text = paste0("Testing Rate",
                                    '<br>',
                                    '<i>',
                                    "Malaysia",
                                    '</i>'))) %>%
...
Row {.tabset}
-------------------------------------
### Test positivity ratio by State
```{r}
#load packages
testing_state <- read_csv("P:/COVID-19/R0 Malaysia/data/testing/ippc/testing_state.csv")
...
#get cases into weeks
mas_weeks <- state %>% dplyr::select(date, state, new_cases) 

#get epid week
mas_weeks$epid_week <- MMWRweek(mas_weeks$date)$MMWRweek

#get state pop 
state_pop <- state_data_v2 %>% dplyr::select(state, population_new) 

#filter out the weeks and aggregate
mas_week <- mas_weeks %>% filter(date >as.Date("2020-12-31")) %>%
  filter(epid_week>20 & epid_week <25) %>%
  dplyr::select(epid_week, state, new_cases) %>%
  dplyr::group_by(epid_week, state) %>%
  mutate(cases=sum(new_cases)) %>%
  dplyr::select(epid_week, state, cases) %>%
  unique() %>% 
  left_join (testing_state, by=c("epid_week", "state")) %>%
  left_join(state_pop, by="state") %>%
  mutate(test_rate=(total_screened/population_new)*1000)
...
#layput test positivity by state
state_test_curve <- ggplot(data=mas_week, aes(x=epid_week)) + 
  geom_bar(aes(y=cases, colour="Daily cases"),stat="identity", fill="grey") +
  geom_line(aes(y=positive_ratio*1000, col="Test positivity ratio"),alpha=0.7, size=1.05) +
  scale_y_continuous(sec.axis = sec_axis(~./1000, name = "Test positivity ratio (%)"))+
  scale_color_manual(name=" ",
                     values=c("Daily cases"="grey", "Test positivity ratio"="deeppink2"
                              )) +
  facet_wrap(~state) +
  labs(x="Epidemiologic week", y="Daily cases",
       title = "Test positivity ratio by states in Malaysia") +
  theme_minimal() +
  ...
  xlim(c(min(mas_week$epid_week)-1, max(mas_week$epid_week)+3)) +
  geom_hline(yintercept=5000, linetype="dashed", col="grey79", size=1.1) +
  geom_hline(yintercept=10000, linetype="dashed", col="grey79", size=1.1) +
  geom_text(aes(x =max(mas_week$epid_week)+2, y = 5700, 
                label = "TPR: 5%", fontface="plain"),size=2, col="grey49") +
  geom_text(aes(x =max(mas_week$epid_week)+2, y = 10700,
                label = "TPR: 10%", fontface="plain"),size=2, col="grey49")
state_test_curve

ggplotly(state_test_curve) %>% layout(
    images = list(
      list(source = base64enc::dataURI(file = "Picture1.png"),
           xref = "paper",
           yref = "paper",
...
### Testing rate by State
```{r}
#layput test positivity by state
state_test_rate_curve <- ggplot(data=mas_week, aes(x=epid_week)) + 
  geom_bar(aes(y=cases, colour="Daily cases"),stat="identity", fill="grey") +
  geom_line(aes(y=test_rate*100, col="Testing rate"),alpha=0.7, size=1.05) +
  scale_y_continuous(sec.axis = sec_axis(~./100, name = "Testing rate /n(per 1000 population"))+
  scale_color_manual(name=" ",
                     values=c("Daily cases"="grey", "Testing rate"="deeppink2"
                              )) +
  facet_wrap(~state) +
  labs(x="Epidemiologic week", y="Daily cases",
       title = "Testing rate by states in Malaysia") +
  theme_minimal() +
  theme(axis.text = element_text(size=8),
        axis.title = element_text(size=8),
        strip.text = element_text(size=8),
        ...
        legend.text = element_text(size=10),
        legend.title=element_text(size=10)) +
  xlim(c(min(mas_week$epid_week)-1, max(mas_week$epid_week)+3.5)) +
  geom_hline(yintercept=5000, linetype="dashed", col="grey79", size=1.1) +
  geom_hline(yintercept=10000, linetype="dashed", col="grey79", size=1.1) +
  geom_hline(yintercept=1000, linetype="dashed", col="grey79", size=1.1) +
  geom_text(aes(x =max(mas_week$epid_week)+2, y = 5700, 
                label = "TR: 50 per 1k population", fontface="plain"), size=2, col="grey49") +
  geom_text(aes(x =max(mas_week$epid_week)+2, y = 10700, 
                label = "TR: 100 per 1k population", fontface="plain"), size=2, col="grey49") +
  geom_text(aes(x =max(mas_week$epid_week)+2, y = 1700, 
                label = "TR: 10 per 1k population", fontface="plain"), size=2, col="grey49")
state_test_rate_curve
ggplotly(state_test_rate_curve) %>% layout(
    images = list(
      list(source = base64enc::dataURI(file = "Picture1.png"),
           xref = "paper",
           yref = "paper",
...
mas_spdf <- shapefile("C:/Users/sueth/Documents/data/gadm36_MYS_shp/gadm36_MYS_1.shp")

#check map labels against data labels for countries
map_labels <- mas_spdf@data[["NAME_1"]]
mas_labels <- mas_week$state

#check for similarities and differences
# map_labels %in% mas_labels
# intersect(map_labels,mas_labels)
# setdiff(map_labels,mas_labels)
# setdiff(mas_labels,map_labels)

#rename certain differing states
mas_spdf@data$NAME_1[mas_spdf@data$NAME_1=="Trengganu"] <- "Terengganu"
mas_spdf@data$NAME_1[mas_spdf@data$NAME_1=="Kuala Lumpur"] <- "W.P. Kuala Lumpur"
mas_spdf@data$NAME_1[mas_spdf@data$NAME_1=="Putrajaya"] <- "W.P. Putrajaya"
mas_spdf@data$NAME_1[mas_spdf@data$NAME_1=="Labuan"] <- "W.P. Labuan"
mas_week$NAME_1 <- mas_week$state

#merge datasets
mas_latest <- mas_week %>% filter(epid_week==max(mas_week$epid_week))
mas_spdf <- merge(mas_spdf,mas_latest,by="NAME_1", duplicateGeoms = T)

#create the maps
# Prepare the text for tooltips:
mytext <- paste(
  "State: ", mas_spdf@data$NAME_1,"<br/>",
  "Test positivity ratio: ", round(mas_week$positive_ratio, 2), 
  sep="") %>%
...
bins <- c(0,5,10,15)
pal <- colorBin(
  palette = c("deeppink2", "greenyellow","seagreen4"),
  domain = mas_spdf@data$positive_ratio,
  reverse = T,
  bins = bins
)

# Bin
tpr_states <- leaflet(mas_spdf)%>%
  setView(lng=110, lat=4.5, zoom=5.4) %>%
  addTiles()  %>% 
  ...
  addLegend( pal=pal, values=~positive_ratio, opacity=0.9, 
             title = "Test positivity ratio (%)", position = "bottomleft")
tpr_states
```
...
mytext <- paste(
  "State: ", mas_spdf@data$NAME_1,"<br/>",
  "Testing rate: ", round(mas_week$test_rate, 2), 
  sep="") %>%
  lapply(htmltools::HTML)

#prepare colors
bins <- c(0, 5,10 ,50, 150)
pal <- colorBin(
  palette = c("deeppink2","#FFF000", "greenyellow","seagreen4"),
  domain = mas_spdf@data$test_rate,
  reverse = F,
  bins = bins,
...
tr_states <- leaflet(mas_spdf)%>%
  ...
  addLegend( pal=pal, values=~test_rate, opacity=0.9, 
             title = "Testing rate (per 1000 population)", position = "bottomleft")
tr_states
```
...
voc_v4 <- read_excel("P:/COVID-19/R0 Malaysia/data/voc/voc_v4.xlsx", 
    sheet = "states", col_types = c("date", 
        ...
        "text", "text", "text", "text"))
voc_states <- voc_v4 %>% dplyr::select(date, state, cases, variant, status, data)

#write to data tests and cases
write.csv(core_set, "P:/COVID-19/covid-19-epi/data/cases.csv")
write.csv(state, "P:/COVID-19/covid-19-epi/data/state.csv")
write.csv(test, "P:/COVID-19/covid-19-epi/data/tests.csv")
write.csv(voc_states, "P:/COVID-19/covid-19-epi/data/voc_states.csv")
```
