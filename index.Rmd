...
ts_mas$mortality_14d <- round((ts_mas$mortality14/mas_pop)*100000,2)
...
mas_death_curve <- plot_ly() %>%
  add_lines(data=mas_state, x=~date,y = ~mortality14_rate, name=~state, color=~state,
            colors=c("#0000FF", "#63B8FF", "#006400", "#008B45", "#54FF9F", "#C71585", "#EEC900", "#FF8C00", "#68228B", "#FFAEB9", "#CD2626", "#008B8B", "#ADD8E6",
                      "#F08080", "#696969", "#2B2B2B", "#FF1493")) %>%
