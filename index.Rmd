...
clusters <- read_csv("P:/COVID-19/R0 Malaysia/data/cluster data/clusters3.csv", 
...
df$ins <- df$dti+df$tembok+df$benteng_pk+df$penjara_reman+df$penjara_jawi+df$kepayan+df$penjara_tapah+
  ...
  df$tembok_mempaga + df$telok_mas
...
new <- new %>%
  mutate(daily_ma01 = rollmean(new_cases, k = 5, fill = NA))
...
#load data
Global_Mobility_Report_3_ <- read_csv("P:/COVID-19/R0 Malaysia/data/mobility/Global_Mobility_Report_210105.csv", 
...
df <- read_csv("P:/COVID-19/R0 Malaysia/data/incidence/covid-19_my_state.csv", 
        col_types = cols(date = col_date(format = "%d/%m/%Y"), 
...
perlis_r0_df <- perlis_r0_df %>%
  mutate(daily_ma01 = rollmean(case, k = 5, fill = NA))
...
sabah$hbed <- state_data_v2$total_gov_beds[state_data_v2$state=="Sabah_29102020"]
...
names(ts_mas)[names(ts_mas)=="daily_ma1"] <- "5-day moving average"
...
mas_epid_curve <- ggplot(data=ts_mas,aes(x=date)) +
  ...
  geom_line(aes(y=`5-day moving average`,col="5-day moving average"), size=0.8)+
  scale_colour_manual(name = "",labels = c("5-day moving average"="5-day moving average",
                                 "Daily New Cases"="Daily New Cases"),
                      values = c("Daily New Cases"="transparent", "5-day moving average"="royalblue3")) +
  theme_minimal() +
...
names(perlis)[names(perlis)=="daily_ma01"] <- "5-day moving average"
...
perlis_epid_curve <- ggplot(data=perlis,aes(x=date)) +
  ...
  scale_colour_manual(name = "",labels = c("5-day moving average"="5-day moving average",
                                 "Daily New Cases"="Daily New Cases"),
                      values = c("Daily New Cases"="transparent", "5-day moving average"="seagreen2")) +
  theme_minimal() +
  theme(legend.position = c(.95, .5),
        legend.justification = c("right", "top"),
        legend.box.just = "right",
...
names(kedah)[names(kedah)=="daily_ma01"] <- "5-day moving average"
...
names(penang)[names(penang)=="daily_ma01"] <- "5-day moving average"
...
names(perak)[names(perak)=="daily_ma01"] <- "5-day moving average"
...
names(selangor)[names(selangor)=="daily_ma01"] <- "5-day moving average"
...
names(kl)[names(kl)=="daily_ma01"] <- "5-day moving average"
...
names(putrajaya)[names(putrajaya)=="daily_ma01"] <- "5-day moving average"
...
names(melaka)[names(melaka)=="daily_ma01"] <- "5-day moving average"
...
names(negeri)[names(negeri)=="daily_ma01"] <- "5-day moving average"
...
names(johor)[names(johor)=="daily_ma01"] <- "5-day moving average"
...
names(pahang)[names(pahang)=="daily_ma01"] <- "5-day moving average"
...
names(terengganu)[names(terengganu)=="daily_ma01"] <- "5-day moving average"
...
terengganu_epid_curve <- ggplot(data=terengganu,aes(x=date)) +
  ...
  scale_x_date(date_breaks = "4 week", date_minor_breaks = "1 day",
               date_labels = "%e %b", limits =c(as.Date(Sys.Date()-91),as.Date(Sys.Date()+1))) +
  labs(x = "Date", y="Cases")
ggplotly(terengganu_epid_curve) %>%
  layout(title = list(text = paste0("Epidemic curve of COVID-19",
                                    '<br>',
                                    '<i>',
                                    'Terengganu',
...
names(kelantan)[names(kelantan)=="daily_ma01"] <- "5-day moving average"
...
names(sarawak)[names(sarawak)=="daily_ma01"] <- "5-day moving average"
...
names(sabah)[names(sabah)=="daily_ma01"] <- "5-day moving average"
...
names(labuan)[names(labuan)=="daily_ma01"] <- "5-day moving average"
...
mas_state <-  mas_state %>% mutate(lines =ifelse(state %in% c("Sabah","Sarawak","W.P. Kuala Lumpur","Pulau Pinang", "Perlis","Negeri Sembilan","Kelantan"),"dashed", "solid"))

#plot the incidence curve
mas_inc_curve <- ggplot(data=mas_state) +
  geom_line(aes(x=date, y=incidence, col=state), size=1.05) +
 scale_colour_manual(values=c("blue",
                               "steelblue1", "darkgreen", 
                               "springgreen4",
                               "seagreen1",
                               "mediumvioletred",
                               "gold2", "darkorange",
                               "darkorchid4","lightpink1",
                               "firebrick3",
                               "darkcyan",
                               "lightblue",
                               "lightcoral",
                              "dimgray", "grey17","deeppink1"
  ))+
  theme_minimal() +
  theme(legend.position = c(.95, .5),
        legend.justification = c("right", "top"),
  ...
  scale_x_date(date_breaks = "2 week", date_minor_breaks = "1 day",
               date_labels = "%e %b", limits =c(as.Date(Sys.Date()-91),as.Date(Sys.Date()+1))) +
  scale_y_continuous(trans = "log10", limits = c(1,10000), breaks = c(1,10,100,1000,10000)) +
  labs(x = "Date", y=paste0("Cumulative Incidence density",
                                    '<br>',
                                    "(per 100,000 population)"), 
       col="State") 

ggplotly(mas_inc_curve) %>%
  layout(title = list(text = paste0("Cumulative Incidence of COVID-19 cases",
                                    '<br>',
                                    '<i>',
...
#plot the incidence curve
mas_den_curve <- ggplot(data=mas_state) +
  geom_line(aes(x=date, y=incidence14_rate, col=state), size=1.05) +
 scale_colour_manual(values=c("blue",
                               "steelblue1", "darkgreen", 
                               "springgreen4",
                               "seagreen1",
  ...
  scale_x_date(date_breaks = "2 week", date_minor_breaks = "1 day",
               date_labels = "%e %b", limits =c(as.Date(Sys.Date()-91),as.Date(Sys.Date()+1))) +
  scale_y_continuous(trans = "log10", limits = c(0.1,10000), breaks = c(0,1,10,100,1000,10000)) +
  labs(x = "Date", y=paste0("Incidence density",
                                    '<br>',
                                    "(per 100,000 population)"), col="State")
ggplotly(mas_den_curve) %>%
  layout(title = list(text = paste0("14-day Incidence density of COVID-19 cases",
                                    '<br>',
                                    '<i>',
                                    'Malaysia: National and State Level',
                                    '</i>'))) %>%
...
mas_cap_curve <- ggplot(data=ts_mas,aes(x=date)) +
  geom_line(aes(y=`General bed utilisation (%) (n= 25456 )`,col="General bed utilisation (%) (n= 25456 )"),
            stat="identity",size=0.8, show.legend = T) + 
  ...
  geom_line(aes(y=`Ventilator utilisation (%) (n= 1581 )`, col="Ventilator utilisation (%) (n= 1581 )"),
            stat="identity",size=0.8,alpha=0.6, show.legend = T) +
  scale_colour_manual(name = "",labels = c("General bed utilisation (%) (n= 25456 )"="General bed utilisation (%)\n 
                                           ...
                                           (n= 1581 )"),
                      values = c("General bed utilisation (%) (n= 25456 )"="midnightblue", 
                                 "ICU bed utilisation (%) (n= 871 )"="firebrick2", 
                                 "Ventilator utilisation (%) (n= 1581 )"="seagreen2")) +
  geom_hline(aes(yintercept=100),colour="red", linetype="dashed",size=0.5) +
  geom_hline(aes(yintercept=70),colour="gold1", linetype="dashed",size=0.5) +
  theme_minimal() +
  theme(legend.position = c(.95, .5),
        legend.justification = c("right", "top"),
        legend.box.just = "right",
...
mas_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         ...
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(ts_mas_short$`Daily New Cases`)+20),
...
mas_trans_curve %>%
  ...
  layout(yaxis2 = list(type = "log",
                      tickvals = as.list(c(seq(0.2,1,0.2), seq(2,8,2))))) %>%
  config(modeBarButtonsToRemove = c("zoomIn2d", "zoomOut2d", "autoScale2d", "resetScale2d", "hoverClosestCartesian", "hoverCompareCartesian","lasso2d", "select2d", "pan2d","zoom2d")) %>%
...
perlis_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(perlis$`Daily New Cases`)+5),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.079442/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
kedah_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(kedah$`Daily New Cases`)+50),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.079442/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
penang_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(penang$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
...
perak_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(perak$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
selangor_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(selangor$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
kl_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(kl$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
putrajaya_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(putrajaya$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
melaka_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(melaka$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
negeri_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(negeri$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
johor_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(johor$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
kelantan_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(kelantan$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
sarawak_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(sarawak$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
sabah_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(sabah$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
labuan_trans_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct((Sys.Date()-91), format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(labuan$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=10), color='grey9', range=c(-1, 2.302585/2),type = "log",
                       title = paste("R",'<sup>',"t",'</sup>')),
...
mas_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(ts_mas$`Daily New Cases`)+100),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
...
perlis_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
        xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(perlis$`Daily New Cases`)+20),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
penang_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(penang$`Daily New Cases`)+40),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
selangor_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(selangor$`Daily New Cases`)+40),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
putrajaya_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(putrajaya$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
melaka_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(melaka$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                      title = paste0("Average change from",
...
negeri_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(negeri$`Daily New Cases`)+30),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
johor_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(johor$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
pahang_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(pahang$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
terengganu_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(terengganu$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
kelantan_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(kelantan$`Daily New Cases`)+10),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
...
sabah_mob_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12), 
         xaxis = list(title="Date",
            ...
            c(as.numeric(as.POSIXct(Sys.Date()-91, format="%Y-%m-%d"))*1000,
              as.numeric(as.POSIXct(Sys.Date(), format="%Y-%m-%d"))*1000)),
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(sabah$`Daily New Cases`)+100),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(-100,100),
                       title = paste0("Average change from",
