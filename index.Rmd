...
clusters <- read_csv("P:/COVID-19/R0 Malaysia/data/cluster data/clusters_dashboard_v2.csv", 
...
#pull new data set
df <- read_csv("P:/COVID-19/R0 Malaysia/data/incidence/covid-19_my_v3.csv", 
...
df <- read_csv("P:/COVID-19/R0 Malaysia/data/incidence/covid-19_my_state_v4.csv", 
        col_types = cols(date = col_date(format = "%d/%m/%Y"), 
...
mas_test_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         ...
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(test_mas$cases)*1.15),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(0,15),
...
mas_test_curve <- plot_ly() %>%
  ...
  layout(titlefont=list(size=12),
         ...
         yaxis = list(tickfont= list(color = 'grey9', size=8), color='grey9', range=c(0,max(test_mas$new_cases)*1.15),
                      title="Daily new cases (count)"),
         yaxis2 = list(overlaying = "y", side = "right",
                       tickfont = list(color = 'grey9', size=8), color='grey9', range=c(0,5),
